%
% Bifurcation diagram for the (scalar) fractional difference logistic map.
%
...
figure('Units','normalized','Position',[0.05 0.05 0.75 0.45],'Color',[1 1 1]);   
...
tyi  = [0 0.2 0.4 0.6 0.8 1]*x_numpoints;  
tyi(1,1) = 1;
yticklabels({'0','0.2','0.4','0.6','0.8','$\lambda_0^{(k)}$'});
set(gca,'YTick',tyi);

txi = ((exp([0 1 2 3 3.38 3.7999])-exp(0))/(exp(3.7999)-exp(0)))*(a_numpoints); 
